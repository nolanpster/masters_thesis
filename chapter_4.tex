	...
	\begin{center}
		\fbox{
			\begin{minipage}{0.75\textwidth}
				...
				\caption{50 trial average: Fraction of max $\InfNorm{\policy{2},\estimate{\policy{}}_2}$ with parameters in Table}
	...
	\begin{center}
		\fbox{
			\begin{minipage}{0.75\textwidth}
				...
				\caption{50 trial average: Fraction of max $\InfNorm{\policy{2},\estimate{\policy{}}_2}$ with Algorithm parameters in Table \ref{table:single_agent_active_alg_params_long}.}
...
\subsection{Proactive Multi-agent Experiment}
	...
	The bonus-reward coerces \agent{1} to make sub-optimal actions so that an informative joint-state is reached, \agent{2} makes informative actions, and the $\InfNorm{\policy{2},\estimate{\policy{}}_2}$ converges faster than with the passive approach; see Figure \ref{fig:multi_agent_active_error}
	...
	\begin{center}
		\fbox{
			\begin{minipage}{0.75\textwidth}
				...
				\caption{50 trial average: Fraction of max $\InfNorm{\policy{2},\estimate{\policy{}}_2}$ with Algorithm parameters in Table \ref{table:multi_agent_active_alg_params}.}
...
\todo[inline]{Add plot of $\InfNorm{\optimal{\policy{1}}, \policy{1}^b}$ and discuss}
