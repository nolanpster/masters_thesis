...
Assuming that \agent{1} has received some initial data $D^{(1)}$, the estimated policy of the uncontrollable agent can
...
required by Assumption \ref{assump:opt_policy_err}. Therefore, \agent{1} will need to gather more data, sets of
...
expert during a rollout, this implementation can only request another demonstration from \agent{2}.  Ideally, the
    ...
    \begin{center}
        \fbox{
            \begin{minipage}{0.75\textwidth}
                ...
                \caption{50 trial average: Fraction of maximum possible $\OneNorm{\policy{2},\estimate{\policy{}}_2}$
                         with parameters in Table}
    ...
    \begin{center}
        \fbox{
            \begin{minipage}{0.75\textwidth}
                ...
                \caption{50 trial average: Fraction of maximum possible $\OneNorm{\policy{2},\estimate{\policy{}}_2}$
                         with Algorithm parameters in Table \ref{table:single_agent_active_alg_params_long}.}
    ...
    \begin{center}
        \fbox{
            \begin{minipage}{0.75\textwidth}
                ...
                \caption{100 trial average: Fraction of maximum possible $\OneNorm{\policy{2},\estimate{\policy{}}_2}$
                         with Algorithm parameters in Table \ref{table:single_agent_active_alg_two_stage}.}
...
for inference. Given some initial idea about the hidden policy of \agent{2}, a user could intentionally design a set of
    ...
    \begin{center}
        \fbox{
            \begin{minipage}{0.75\textwidth}
                ...
                \caption{50 trial average: Fraction of maximum possible $\OneNorm{\policy{2},\estimate{\policy{}}_2}$
                         with Algorithm parameters in Table \ref{table:multi_agent_active_alg_params}.}
